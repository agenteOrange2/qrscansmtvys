...
const codePreviewComputedClass = computed(() =>
  twMerge([
    ...
    "before:content-['HTML'] before:font-roboto before:font-medium before:px-4 before:py-2 before:block before:absolute before:top-0 before:right-0 before:rounded-bl before:bg-slate-200/70 before:dark:bg-darkmode-400",
